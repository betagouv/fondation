...
export type UpdateOfficialReportDto = {
  sessionMeetingDate: {
    year: number;
    month: number;
    day: number;
...
export type DetailedOfficialReportDocumentDto = {
  blocks: Array<
    | {
        weight: number;
        edited: boolean;
...
export type EditOfficialReportBlockDto = {
  html: string;
  outdated: boolean;
};

export type EditOfficialReportSectionTitleDto = {
  text: string;
};

export type EditOfficialReportSectionIntroBlockDto = {
  html: string;
};
...
export type UpdateReportRuleValidationResponse =
  UpdateReportRuleValidationResponses[keyof UpdateReportRuleValidationResponses];
...
export type ListSessionsOfTypeGardeDesSceauxResponse =
  ListSessionsOfTypeGardeDesSceauxResponses[keyof ListSessionsOfTypeGardeDesSceauxResponses];
...
export type CountUsersNewSessionsResponse =
  CountUsersNewSessionsResponses[keyof CountUsersNewSessionsResponses];
...
export type CreateSessionFromLodamResponse =
  CreateSessionFromLodamResponses[keyof CreateSessionFromLodamResponses];
...
export type UpdateSessionObserversResponse =
  UpdateSessionObserversResponses[keyof UpdateSessionObserversResponses];
...
export type DetailNominationSessionAffectationsVersionResponse =
  DetailNominationSessionAffectationsVersionResponses[keyof DetailNominationSessionAffectationsVersionResponses];
...
export type CountUnaffectedNominationFilesResponse =
  CountUnaffectedNominationFilesResponses[keyof CountUnaffectedNominationFilesResponses];
...
export type CountNominationFilesByStatusResponse =
  CountNominationFilesByStatusResponses[keyof CountNominationFilesByStatusResponses];
...
export type ListCurrentlyAffectedReportersResponse =
  ListCurrentlyAffectedReportersResponses[keyof ListCurrentlyAffectedReportersResponses];
...
export type PublishNominationSessionAffectationsVersionResponse =
  PublishNominationSessionAffectationsVersionResponses[keyof PublishNominationSessionAffectationsVersionResponses];
...
export type UpdateNominationFileCommentResponse =
  UpdateNominationFileCommentResponses[keyof UpdateNominationFileCommentResponses];
...
export type UpdateNominationFileMissingEvaluationResponse =
  UpdateNominationFileMissingEvaluationResponses[keyof UpdateNominationFileMissingEvaluationResponses];
...
export type UpdateNominationFileMissingEvaluationCommentResponse =
  UpdateNominationFileMissingEvaluationCommentResponses[keyof UpdateNominationFileMissingEvaluationCommentResponses];
...
export type UpdateNominationFileAuditionDateResponse =
  UpdateNominationFileAuditionDateResponses[keyof UpdateNominationFileAuditionDateResponses];
...
export type DefineNominationFilesOutcomeResponse =
  DefineNominationFilesOutcomeResponses[keyof DefineNominationFilesOutcomeResponses];
...
export type DefineNominationFileOutcomeResponse =
  DefineNominationFileOutcomeResponses[keyof DefineNominationFileOutcomeResponses];
...
export type HideNominationFileAlertResponse =
  HideNominationFileAlertResponses[keyof HideNominationFileAlertResponses];
...
export type UploadSessionAttachmentsResponse =
  UploadSessionAttachmentsResponses[keyof UploadSessionAttachmentsResponses];
...
export type RemoveSessionAttachmentResponse =
  RemoveSessionAttachmentResponses[keyof RemoveSessionAttachmentResponses];
...
export type CreateNominationSessionAttachmentUrlResponse =
  CreateNominationSessionAttachmentUrlResponses[keyof CreateNominationSessionAttachmentUrlResponses];
...
export type ListNominationSessionAttachmentsResponse =
  ListNominationSessionAttachmentsResponses[keyof ListNominationSessionAttachmentsResponses];
...
export type ListNominationFileAttachmentsResponse =
  ListNominationFileAttachmentsResponses[keyof ListNominationFileAttachmentsResponses];
...
export type UploadNominationFileAttachmentsResponse =
  UploadNominationFileAttachmentsResponses[keyof UploadNominationFileAttachmentsResponses];
...
export type RemoveNominationFileAttachmentResponse =
  RemoveNominationFileAttachmentResponses[keyof RemoveNominationFileAttachmentResponses];
...
export type CreateNominationFileAttachmentUrlResponse =
  CreateNominationFileAttachmentUrlResponses[keyof CreateNominationFileAttachmentUrlResponses];
...
export type DeleteNominationSessionResponse =
  DeleteNominationSessionResponses[keyof DeleteNominationSessionResponses];
...
export type DetailsNominationSessionResponse =
  DetailsNominationSessionResponses[keyof DetailsNominationSessionResponses];
...
export type UpdateNominationSessionResponse =
  UpdateNominationSessionResponses[keyof UpdateNominationSessionResponses];
...
export type IncludeFilesInContentResponse =
  IncludeFilesInContentResponses[keyof IncludeFilesInContentResponses];
...
export type UpdateSummaryReadersListResponse =
  UpdateSummaryReadersListResponses[keyof UpdateSummaryReadersListResponses];
...
export type GenerateAttachmentPublicUrlResponse =
  GenerateAttachmentPublicUrlResponses[keyof GenerateAttachmentPublicUrlResponses];
...
export type ListMemberSessionReportsResponse =
  ListMemberSessionReportsResponses[keyof ListMemberSessionReportsResponses];
...
export type SearchNominationFileMembersReportResponse =
  SearchNominationFileMembersReportResponses[keyof SearchNominationFileMembersReportResponses];
...
export type WriteNominationFileMemberMemoResponse =
  WriteNominationFileMemberMemoResponses[keyof WriteNominationFileMemberMemoResponses];
...
export type SearchMagistratAuthorizationError =
  SearchMagistratAuthorizationErrors[keyof SearchMagistratAuthorizationErrors];

export type SearchMagistratAuthorizationResponses = {
  200: FoundMagistratAuthorizationDto;
};

export type SearchMagistratAuthorizationResponse =
  SearchMagistratAuthorizationResponses[keyof SearchMagistratAuthorizationResponses];
...
export type ListSecretariesGeneralResponse =
  ListSecretariesGeneralResponses[keyof ListSecretariesGeneralResponses];
...
export type IsSessionReadyForDocGenerationResponse =
  IsSessionReadyForDocGenerationResponses[keyof IsSessionReadyForDocGenerationResponses];
...
export type FindAgendaNominationFilesResponse =
  FindAgendaNominationFilesResponses[keyof FindAgendaNominationFilesResponses];
...
export type DetailsAgendaMetadataResponse =
  DetailsAgendaMetadataResponses[keyof DetailsAgendaMetadataResponses];
...
export type DetailsAgendaDocumentBlocksResponse =
  DetailsAgendaDocumentBlocksResponses[keyof DetailsAgendaDocumentBlocksResponses];
...
export type DetailsSessionOfficialReportResponse =
  DetailsSessionOfficialReportResponses[keyof DetailsSessionOfficialReportResponses];
...
export type ListAgendasForNewOfficialReportResponse =
  ListAgendasForNewOfficialReportResponses[keyof ListAgendasForNewOfficialReportResponses];
...
export type GenerateOfficialReportPdfResponse =
  GenerateOfficialReportPdfResponses[keyof GenerateOfficialReportPdfResponses];
...
export type DetailsOfficialReportResponse =
  DetailsOfficialReportResponses[keyof DetailsOfficialReportResponses];

export type UpdateOfficialReportData = {
  body: UpdateOfficialReportDto;
  path: {
    officialReportId: string;
  };
  query?: never;
...
export type ValidateOfficialReportResponse =
  ValidateOfficialReportResponses[keyof ValidateOfficialReportResponses];
...
export type DetailsOfficialReportDocumentResponses = {
  200: DetailedOfficialReportDocumentDto;
};

export type DetailsOfficialReportDocumentResponse =
  DetailsOfficialReportDocumentResponses[keyof DetailsOfficialReportDocumentResponses];

export type ResetOfficialReportIntroData = {
  body?: never;
  path: {
    officialReportId: string;
  };
...
export type ResetOfficialReportIntroResponses = {
  204: void;
};

export type ResetOfficialReportIntroResponse =
  ResetOfficialReportIntroResponses[keyof ResetOfficialReportIntroResponses];

export type EditOfficialReportIntroData = {
...
export type EditOfficialReportIntroResponses = {
  204: void;
};

export type EditOfficialReportIntroResponse =
  EditOfficialReportIntroResponses[keyof EditOfficialReportIntroResponses];

export type ResetOfficialReportConclusionData = {
  body?: never;
  path: {
    officialReportId: string;
  };
...
export type ResetOfficialReportConclusionResponses = {
  204: void;
};

export type ResetOfficialReportConclusionResponse =
  ResetOfficialReportConclusionResponses[keyof ResetOfficialReportConclusionResponses];

export type EditOfficialReportConclusionData = {
  body: EditOfficialReportBlockDto;
  path: {
    officialReportId: string;
  };
...
export type EditOfficialReportConclusionResponses = {
  204: void;
};

export type EditOfficialReportConclusionResponse =
  EditOfficialReportConclusionResponses[keyof EditOfficialReportConclusionResponses];

export type ResetOfficialReportSectionTitleData = {
  body?: never;
  path: {
    officialReportId: string;
    outcome: 'VALIDATED' | 'NON_VALIDATED' | 'WITHDRAWN' | 'SUSPENDED';
...
export type ResetOfficialReportSectionTitleResponses = {
  204: void;
};

export type ResetOfficialReportSectionTitleResponse =
  ResetOfficialReportSectionTitleResponses[keyof ResetOfficialReportSectionTitleResponses];

export type EditOfficialReportSectionTitleData = {
...
export type EditOfficialReportSectionTitleResponses = {
  204: void;
};

export type EditOfficialReportSectionTitleResponse =
  EditOfficialReportSectionTitleResponses[keyof EditOfficialReportSectionTitleResponses];

export type ResetOfficialReportSectionIntroData = {
  body?: never;
  path: {
    officialReportId: string;
    outcome: 'VALIDATED' | 'NON_VALIDATED' | 'WITHDRAWN' | 'SUSPENDED';
...
export type ResetOfficialReportSectionIntroResponses = {
  204: void;
};

export type ResetOfficialReportSectionIntroResponse =
  ResetOfficialReportSectionIntroResponses[keyof ResetOfficialReportSectionIntroResponses];

export type EditOfficialReportSectionIntroData = {
...
export type EditOfficialReportSectionIntroResponses = {
  204: void;
};

export type EditOfficialReportSectionIntroResponse =
  EditOfficialReportSectionIntroResponses[keyof EditOfficialReportSectionIntroResponses];

export type ResetOfficialReportFileData = {
  body?: never;
  path: {
    officialReportId: string;
    nominationFileId: string;
...
export type ResetOfficialReportFileResponses = {
  204: void;
};

export type ResetOfficialReportFileResponse =
  ResetOfficialReportFileResponses[keyof ResetOfficialReportFileResponses];
...
export type EditOfficialReportFileResponse =
  EditOfficialReportFileResponses[keyof EditOfficialReportFileResponses];
...
export type ResetOfficialReportDocumentResponse =
  ResetOfficialReportDocumentResponses[keyof ResetOfficialReportDocumentResponses];
...
export type ListPresentationPlanAgendasResponse =
  ListPresentationPlanAgendasResponses[keyof ListPresentationPlanAgendasResponses];
...
export type DeleteJusticePresentationPlanResponse =
  DeleteJusticePresentationPlanResponses[keyof DeleteJusticePresentationPlanResponses];
...
export type DetailsPresentationPlanMetadataResponse =
  DetailsPresentationPlanMetadataResponses[keyof DetailsPresentationPlanMetadataResponses];
...
export type UpdateJusticePresentationPlanResponse =
  UpdateJusticePresentationPlanResponses[keyof UpdateJusticePresentationPlanResponses];
...
export type ListNonPresentedPlansResponse =
  ListNonPresentedPlansResponses[keyof ListNonPresentedPlansResponses];
...
export type CreateJusticePresentationPlanResponse =
  CreateJusticePresentationPlanResponses[keyof CreateJusticePresentationPlanResponses];
...
export type DetailsJusticePresentationPlanPdfDocumentResponse =
  DetailsJusticePresentationPlanPdfDocumentResponses[keyof DetailsJusticePresentationPlanPdfDocumentResponses];
...
export type UpdatePresentationPlanHtmlResponse =
  UpdatePresentationPlanHtmlResponses[keyof UpdatePresentationPlanHtmlResponses];
...
export type ResetPresentationPlanDocumentResponse =
  ResetPresentationPlanDocumentResponses[keyof ResetPresentationPlanDocumentResponses];
...
export type ListMagistratNominationFilesResponse =
  ListMagistratNominationFilesResponses[keyof ListMagistratNominationFilesResponses];
...
export type ListMagistratObservationsResponse =
  ListMagistratObservationsResponses[keyof ListMagistratObservationsResponses];
...
export type GetObservationDetailsResponse =
  GetObservationDetailsResponses[keyof GetObservationDetailsResponses];
...
export type GetObservationFileUrlResponse =
  GetObservationFileUrlResponses[keyof GetObservationFileUrlResponses];
...
export type AttachMemberCommentScreenshotsResponse =
  AttachMemberCommentScreenshotsResponses[keyof AttachMemberCommentScreenshotsResponses];
...
export type FollowUpOnObservationResponse =
  FollowUpOnObservationResponses[keyof FollowUpOnObservationResponses];
...
export type ListObservationsAttachmentsResponse =
  ListObservationsAttachmentsResponses[keyof ListObservationsAttachmentsResponses];
