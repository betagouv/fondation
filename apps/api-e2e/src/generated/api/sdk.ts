...
export class reports {
    ...
    public static searchMyReport<ThrowOnError extends boolean = false>(options: Options<SearchMyReportData, ThrowOnError>): RequestResult<SearchMyReportResponses, unknown, ThrowOnError> {
        return (options.client ?? client).get<SearchMyReportResponses, unknown, ThrowOnError>({ url: '/api/reports/v2/nomination-files/{nominationFileId}/mine', ...options });
    }
