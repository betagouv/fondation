...
export class sessions {
    ...
    public static detailSessionComment<ThrowOnError extends boolean = false>(options: Options<DetailSessionCommentData, ThrowOnError>): RequestResult<DetailSessionCommentResponses, unknown, ThrowOnError> {
        return (options.client ?? client).get<DetailSessionCommentResponses, unknown, ThrowOnError>({ url: '/api/sessions/v2/{sessionId}/comment', ...options });
    }
    
    public static writeSessionComment<ThrowOnError extends boolean = false>(options: Options<WriteSessionCommentData, ThrowOnError>): RequestResult<WriteSessionCommentResponses, unknown, ThrowOnError> {
        return (options.client ?? client).put<WriteSessionCommentResponses, unknown, ThrowOnError>({
    ...
    public static detailAffectationHistory<ThrowOnError extends boolean = false>(options: Options<DetailAffectationHistoryData, ThrowOnError>): RequestResult<DetailAffectationHistoryResponses, unknown, ThrowOnError> {
        return (options.client ?? client).get<DetailAffectationHistoryResponses, unknown, ThrowOnError>({ url: '/api/sessions/v2/{sessionId}/files/reporters/versions/history', ...options });
    }
    ...
    public static defineNominationFilesOutcome<ThrowOnError extends boolean = false>(options: Options<DefineNominationFilesOutcomeData, ThrowOnError>): RequestResult<DefineNominationFilesOutcomeResponses, unknown, ThrowOnError> {
...
export class docs {
    ...
    public static validateAgenda<ThrowOnError extends boolean = false>(options: Options<ValidateAgendaData, ThrowOnError>): RequestResult<ValidateAgendaResponses, unknown, ThrowOnError> {
        return (options.client ?? client).post<ValidateAgendaResponses, unknown, ThrowOnError>({ url: '/api/docs/v1/agendas/{agendaId}/validation', ...options });
    }
    
    public static discardAgendaDraft<ThrowOnError extends boolean = false>(options: Options<DiscardAgendaDraftData, ThrowOnError>): RequestResult<DiscardAgendaDraftResponses, unknown, ThrowOnError> {
        return (options.client ?? client).delete<DiscardAgendaDraftResponses, unknown, ThrowOnError>({ url: '/api/docs/v1/agendas/{agendaId}/draft', ...options });
    }
    ...
    public static validateOfficialReport<ThrowOnError extends boolean = false>(options: Options<ValidateOfficialReportData, ThrowOnError>): RequestResult<ValidateOfficialReportResponses, unknown, ThrowOnError> {
        return (options.client ?? client).post<ValidateOfficialReportResponses, unknown, ThrowOnError>({ url: '/api/docs/v1/official-reports/{officialReportId}/validation', ...options });
    }
    
    public static discardOfficialReportDraft<ThrowOnError extends boolean = false>(options: Options<DiscardOfficialReportDraftData, ThrowOnError>): RequestResult<DiscardOfficialReportDraftResponses, unknown, ThrowOnError> {
        return (options.client ?? client).delete<DiscardOfficialReportDraftResponses, unknown, ThrowOnError>({ url: '/api/docs/v1/official-reports/{officialReportId}/draft', ...options });
    }
    ...
    public static validatePresentationPlan<ThrowOnError extends boolean = false>(options: Options<ValidatePresentationPlanData, ThrowOnError>): RequestResult<ValidatePresentationPlanResponses, unknown, ThrowOnError> {
        return (options.client ?? client).post<ValidatePresentationPlanResponses, unknown, ThrowOnError>({ url: '/api/docs/v1/presentation-plans/{planId}/validation', ...options });
    }
