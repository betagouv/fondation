...
export function SidePanel(props: {
  ...
  return (
    <aside
      ...
      aria-modal="true"
      className={clsx(
        'fixed inset-y-0 right-0 z-(--z-index-panel) flex h-full w-full max-w-full flex-col bg-(--background-default-grey) shadow-[-8px_0_24px_rgba(0,0,0,0.16)] transition duration-300 ease-out outline-none md:w-[48%]',
