  ...
  return (
    <div className="flex items-center">
      <div className="peer-focus-within:hidden 2xl:hidden">
        ...
        />
        <p className="fr-m-0 fr-mt-2v text-xs text-(--text-mention-grey)">{search}</p>
      </div>
      ...
      <Input
        ...
        className={clsx(
          ...
          'focus-within:z-10 focus-within:rounded focus-within:bg-(--background-default-grey) focus-within:p-6 focus-within:opacity-100 focus-within:shadow',
