    ...
    [NominationFile.ManagementRule.TRANSFER_TIME]: {
      ...
      hint: (
        <div>
          ...
          <p key="p2">Date de prise de poste pressentie - Date de prise de poste ≥ 3 ans</p>
          <ul key="ul">
            <li key="no-error">
...
Passage du siège au parquet (ou inversement) entre 2 TJ du ressort d'une même CA. Avoir une vigilance particulière pour les infra-pôles.`
  ...
  [NominationFile.RuleGroup.STATUTORY]: {
    [NominationFile.StatutoryRule.JUDICIARY_ROLE_CHANGE_IN_SAME_JURIDICTION]: {
      label: "Passage parquet / siège ou inversement au sein d'une même juridiction en moins de 5 ans",
      hint: (
        <div>
          <p key="p1">
            Passage du siège au parquet ou inversement au sein d'une même juridiction, sans l'avoir quitté
            dans les 5 ans.
          </p>
          <p key="p2">
    ...
    [NominationFile.StatutoryRule.HH_WITHOUT_2_FIRST_GRADE_POSITIONS]: {
      ...
      hint: (
        <div>
          <ul key="ul1">
            <li>
              <p>Pour les magistrats ayant pris leur premier poste avant le 1er septembre 2020 :</p>
            </li>
          </ul>
          <p key="p1">
            Le magistrat proposé doit avoir exercé au moins deux fonctions au 1er grade. Si ces deux fonctions
            sont juridictionnelles, elles doivent avoir été exercées dans deux juridictions différentes, a
            l'exception des conseillers référendaires et avocats généraux référendaires.
          </p>
          <ul key="ul2">
            <li>
              <p>Pour les magistrats ayant pris leur premier poste après le 1er septembre 2020 :</p>
            </li>
          </ul>
          <p key="p2">
            Le magistrat proposé doit également avoir effectué une mobilité non juridictionnelle (mise à
            disposition, détachement).
          </p>
          <p key="p3">Cf. liste des fonctions dans la magistrature.</p>
        </div>
      )
      ...
      hint: (
        <div>
          ...
          <ul key="ul">
            <li key="li1">
              <p>
                Un ancien directeur de centre pénitentiaire sera difficilement proposé pour un poste de juge
                d'application des peines dans la même région.
              </p>
            </li>
            <li key="li2">
              <p>
                Un ancien éducateur de la protection judiciaire de la jeunesse sera difficilement proposé pour
                un poste de juge des enfants dans la même région.
              </p>
            </li>
          </ul>
        </div>
    ...
    [NominationFile.QualitativeRule.CONFLICT_OF_INTEREST_WITH_RELATIVE_PROFESSION]: {
      ...
      hint: (
        <div>
          ...
          <p key="p1">
            On s'assure qu'il n'y a pas de proximité sectorielle et géographique avec un précédent poste
            exercé par le proche, hors de la magistrature.
          </p>
          <p key="p2">Exemples de conflits d'intérêt :</p>
          <ul
            key="ul2"
          ...
          >
            <li key="li1">
              <p>
                Une personne dont le proche est directeur de centre pénitentiaire sera difficilement proposé
                pour un poste de juge d'application des peines dans la même région.
              </p>
            </li>
            <li key="li2">
              <p>
          ...
          <p key="p3">
            Si le magistrat proposé est pressenti pour un poste dans une juridiction du même ressort que celui
            où son proche est en poste, on s'assure de l'absence d'un lien hiérarchique.
          </p>
        </div>
      )
    },
