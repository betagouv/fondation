  ...
  return (
    <div>
      ...
      {isEditing ? (
        ...
        <div
          id={id}
          className="fr-mt-2v fr-p-4v rounded-sm border border-(--border-default-grey) bg-(--background-alt-grey)"
        >
          {displayTitle || <span className="text-(--text-disabled-grey)">Aucun titre</span>}
        </div>
      )}
    </div>
  );
