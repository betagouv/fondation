...
export class observations {
    ...
    public static attachMemberCommentFiles<ThrowOnError extends boolean = false>(options: Options<AttachMemberCommentFilesData, ThrowOnError>) {
        return (options.client ?? client).post<AttachMemberCommentFilesResponses, unknown, ThrowOnError>({
            ...formDataBodySerializer,
