...
export class sessions {
    ...
    public static updateNominationFileAuditionDate<ThrowOnError extends boolean = false>(options: Options<UpdateNominationFileAuditionDateData, ThrowOnError>) {
        return (options.client ?? client).patch<UpdateNominationFileAuditionDateResponses, unknown, ThrowOnError>({
