...
ALTER TABLE "data_administration_context"."transparences" ALTER COLUMN "date_transparence" SET NOT NULL DEFAULT now();
ALTER TABLE "data_administration_context"."transparences" ALTER COLUMN "date_cloture_delai_observation" SET NOT NULL DEFAULT now();
