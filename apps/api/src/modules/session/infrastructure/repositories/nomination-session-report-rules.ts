...
export function getAllNominationSessionReportRules(): Prisma.ReportRuleCreateManyReportInput[] {
  return (
    [
      ...Object.values(NominationFile.ManagementRule).map((ruleName) => ['management', ruleName] as const),
      ...Object.values(NominationFile.StatutoryRule).map((ruleName) => ['statutory', ruleName] as const),
      ...Object.values(NominationFile.QualitativeRule).map((ruleName) => ['qualitative', ruleName] as const),
