...
import { NominationFileRead, nominationFileReadContentSchema } from 'src/data-administration-context/transparence-xlsx/business-logic/models/nomination-file-read';
