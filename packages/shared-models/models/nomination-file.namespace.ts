export namespace NominationFile {
  ...
  export type Rules = {
    [RuleGroup.MANAGEMENT]: Record<ManagementRule, RuleValue>;
    [RuleGroup.STATUTORY]: Record<StatutoryRule, RuleValue>;
    [RuleGroup.QUALITATIVE]: Record<QualitativeRule, RuleValue>;
  };
}
